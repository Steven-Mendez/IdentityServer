...
public interface IRepository<T> where T : BaseEntity
{
    ...
    /// <summary>
    /// Asynchronously retrieves entities of type T based on specified criteria defined by an <see cref="ISpecification{T}"/>.
    /// </summary>
    /// <param name="specification">The specification defining the criteria for filtering entities.</param>
    /// <returns>A task that represents the asynchronous operation, returning a tuple containing filtered entities and total record count.</returns>
