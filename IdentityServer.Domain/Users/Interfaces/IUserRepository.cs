...
public interface IUserRepository : IRepository<User>
{
    ...
    /// <returns>
    ///     A task representing the asynchronous operation. The task result contains the authenticated <see cref="User" />
    ///     .
    /// </returns>
    ...
    /// <returns>
    ///     A task representing the asynchronous operation. The task result contains the <see cref="User" /> with the
    ///     specified email, or null if no user is found.
    /// </returns>
    ...
    /// <returns>
    ///     A task representing the asynchronous operation. The task result contains the <see cref="User" /> with the
    ///     specified Microsoft ID, or null if no user is found.
    /// </returns>
