...
public partial class UserRepository
{
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains a boolean indicating whether the email is unique.</returns>
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains a boolean indicating whether the username is unique.</returns>
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains a boolean indicating whether another user exists with the same email.</returns>
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains a boolean indicating whether another user exists with the same username.</returns>
