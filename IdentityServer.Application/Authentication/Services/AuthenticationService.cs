    ...
    : IAuthenticationService
{
    ...
    {
        return
            $"https://login.microsoftonline.com/{_tenantId}/oauth2/v2.0/authorize?client_id={_clientId}&redirect_uri={_redirectUri}/api/Authentication/azure-ad&response_type=code&scope=user.read";
    }
