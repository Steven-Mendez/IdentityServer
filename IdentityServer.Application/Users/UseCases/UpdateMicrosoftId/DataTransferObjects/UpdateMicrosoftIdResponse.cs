...
/// <summary>
///     Represents the response returned after updating a user's Microsoft ID.
///     This response includes the unique identifier of the user, their Microsoft ID, username, email,
///     optional first name, last name, and avatar, along with a flag indicating whether the user is blocked.
/// </summary>
public class UpdateMicrosoftIdResponse
{
    ...
    /// <summary>
    ///     Gets or sets the Microsoft ID of the user. This is optional.
    /// </summary>
    /// <value>The Microsoft ID of the user, if any.</value>
